    ...
    try {
      ...
      if ((type === 'IMAGE' && !file.type.startsWith('image/')) ||
        ...
        toast({
          ...
          description: `Please upload a ${type.toLowerCase()} file.`,
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        ...
        description: `The ${type.toLowerCase()} has been uploaded successfully.`,
      });
    } catch (error) {
      debug.error("Error uploading file:", error);
      toast({
        title: "Upload failed",
        description: error instanceof Error ? error.message : `Failed to upload ${type.toLowerCase()}`,
        variant: "destructive",
      });
    } finally {
          ...
          {isUploading ? (
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <p className="text-sm font-medium">Uploading {type.toLowerCase()}...</p>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-medium">Click to upload {type.toLowerCase()}</p>
