...
function applyPaymentHeaders(response: NextResponse, nonce: string): void {
  ...
  const cspPolicy = process.env.NODE_ENV === 'production'
    ...
    : `default-src 'self'; script-src 'self' 'unsafe-inline' https://checkout.razorpay.com https://*.razorpay.com 'nonce-${nonce}'; style-src 'self' 'unsafe-inline' https://*.razorpay.com; img-src 'self' data: blob: https://api.dicebear.com https://api.qrserver.com https://*.razorpay.com https://utfs.io; font-src 'self' data: https://*.razorpay.com; connect-src 'self' https://*.uploadthing.com https://utfs.io https://api.razorpay.com https://*.razorpay.com; media-src 'self' blob: http://localhost:* https://*; object-src 'none'; frame-src https://*.razorpay.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self' https://*.razorpay.com;`;
...
function applyStandardCSP(response: NextResponse, nonce: string): void {
  const cspPolicy = process.env.NODE_ENV === 'production'
    ...
    : `default-src 'self'; script-src 'self' 'unsafe-inline' 'nonce-${nonce}'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://api.dicebear.com https://api.qrserver.com https://utfs.io; font-src 'self' data:; connect-src 'self' https://*.uploadthing.com https://utfs.io https://api.razorpay.com https://*.razorpay.com; media-src 'self' blob: http://localhost:* https://*; object-src 'none'; frame-src 'none'; frame-ancestors 'none'; base-uri 'self'; form-action 'self';`;
