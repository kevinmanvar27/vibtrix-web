...
class _UsersApiService implements UsersApiService {
  ...
  Future<RecentlyJoinedResponse> getRecentlyJoinedUsers({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecentlyJoinedResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RecentlyJoinedResponse _value;
    try {
      _value = RecentlyJoinedResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<void> respondToFollowRequest(
    String requestId,
    FollowRequestActionRequest request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
